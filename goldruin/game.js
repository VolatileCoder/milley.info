    ...
    starburst.render = function(deltaT){
        ...
        if( this.sprite.element){
            ...
            if(Date.now()-this._stateStart>250){
                ...
                game.currentRoom.objects.splice(game.currentRoom.objects.indexOf(this),1);
            }
        }
    }
...
images = {
    ...
    ,starburst: "data:image/png;base64,"
}
